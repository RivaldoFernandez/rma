    ...
    <div className="content-2">
        <div className="sidebar-2 fixed top-0 left-0 h-screen w-64 bg-white overflow-hidden">
            ...
            <div className='ajustes-cerrar-2'>
                <ul>
                    <li>
                        <Link to="/Ajustes_Cuenta" className="menu-link-2">
                            <img src={ajustesIcon} alt="Ajustes" className="menu-icon-2" />
                            <span>Ajustes</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="/login" className="menu-link-2">
                            <img src={cerrarIcon} alt="Cerrar" className="menu-icon-2" />
        ...
        <div className="monitoreo-content-2 ml-64">
            ...
            <div className='search-cont-2'>
                <div style={{ display: 'flex' , alignItems: 'center' }}>
                    <input type="text" placeholder="Buscar" className="search-bar-2" style={{ width: '60%' ,
                        marginRight: '5' }} />
                    <div className="icons-2" style={{ marginRight: 'auto' }}>
                        <Link to="/notificaciones">
                            <img src={alarmIcon} alt="Notificaciones" className="icon-2" />
                        </Link>
                        <Link to="/ajustes_cuenta">
                            <img src={profileIcon} alt="Ajustes_Cuenta" className="icon-2 profile-icon" />
                        </Link>
                    </div>
                </div>
            ...
            <div className="valvula-container">
                <h1 className='nombre-valvula'><strong>Válvula</strong></h1>
            ...
            <div>
                <h1 className='nombre-estacion'><strong>Estación meteorológica:</strong></h1>
