                ...
                <div className="historial-content-3 ml-64">
                        ...
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <div className="icons-3" style={{ marginRight: 'auto' }}>
                                <Link to="/notificaciones">
                                    <img src={alarmIcon} alt="Notificaciones" className="icon-3" />
                                </Link>
                                <Link to="/ajustes_cuenta">
                                    <img src={profileIcon} alt="Ajustes_Cuenta" className="icon-3 profile-icon" />
                                </Link>
                            </div>
                        </div>
                    </div>
                    <div className="filtros-container">
                        <div className="filtro-item">
                            ...
                            <select name="valvula" className="select" value={selectedEstacion1} onChange={handleEstacionChange1}>
                        ...
                        <div className="filtro-item">
                            ...
                            <select name="valor" className="select" value={selectedValor1} onChange={handleValorChange1}>
                                <option value="">Seleccione</option>
                    ...
                    <div className="filtros-container-meteorologica">
                        ...
                        <div className="filtro-item">
                            <h1 className="titulo">Seleccione valor:</h1>
                            <select name="valor" className="select" value={selectedValor2} onChange={handleValorChange2}>
                                <option value="">Seleccione</option>
