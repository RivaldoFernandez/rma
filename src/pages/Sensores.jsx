            ...
            <div className="content-sensores">
                ...
                <div className="sidebar fixed top-0 left-0 h-screen w-64 bg-white overflow-hidden">
                    ...
                    <div className='ajustes-cerrar-sensores'>
                        <ul>
                            <li>
                                <Link to="/Ajustes_Cuenta" className="menu-link-sensores">
                                    <img src={ajustesIcon} alt="Ajustes" className="menu-icon-sensores" />
                                    <span>Ajustes</span>
                                </Link>
                            </li>
                            <li>
                                <Link to="/login" className="menu-link-sensores">
                                    <img src={cerrarIcon} alt="Cerrar" className="menu-icon-sensores" />
                ...
                <div className="sensores-content-sensores ml-64">
                    ...
                    <div className='search-cont-sensores'>
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            <input type="text" placeholder="Buscar" className="search-bar-sensores" style={{ width: '60%', marginRight: '5px' }} />
                            <div className="icons-sensores" style={{ marginRight: 'auto' }}>
                                <Link to="/notificaciones">
                                    <img src={alarmIcon} alt="Notificaciones" className="icon-sensores" />
                                </Link>
                                <Link to="/ajustes_cuenta">
                                    <img src={profileIcon} alt="Ajustes_Cuenta" className="icon-sensores profile-icon-sensores" />
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container-sensores">
                        <h1 className='Estacion-mt-sensores'><strong>Estación Meteorológica :</strong></h1>
                    </div>
                    ...
                    <div className="container-sensores">
                        <h2 className='Estacion-mt-sensores'><strong>Sensores de Humedad</strong></h2>
                    </div>
